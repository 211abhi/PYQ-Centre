...
export default function Header() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      console.log('Initial theme setup:', { savedTheme, isDarkMode, classes: html.classList.toString() });
    }
  }, []);
  ...
  const toggleTheme = () => {
    ...
    if (newIsDark) {
      ...
      console.log('Applied dark mode, classes:', html.classList.toString());
    } else {
      html.classList.remove('dark');
      html.classList.add('light'); // Explicitly add light class
      localStorage.setItem('theme', 'light');
      console.log('Applied light mode, classes:', html.classList.toString());
    }
